function [joint, map, pathmap] = setPanel( parameters, fontsize, width, height )
...
axMap.XLabel.String = 'Angle (rad)'; % Name x axis
axMap.YLabel.String = 'Angular rate (rad/s)'; % Name y axis
