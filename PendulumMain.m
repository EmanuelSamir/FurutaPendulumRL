...
rateRange = 0.2;          % Switch to second controller when qd reaches the ball of radius rateRange
...
Neurons = [InputSize 10 10 OutputSize];         % Neurons per layers (input, hidden1, hidden2, output)
